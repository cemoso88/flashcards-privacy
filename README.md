...
- `index.html` — Single-Page, DE + EN auf einer Seite (Sprachumschalter), Dark-Mode-aware, kein JS-Framework, kein Tracking.

## Editieren

Datei bearbeiten, committen, pushen. GitHub Pages re-deployed automatisch innerhalb 1–2 Minuten.
